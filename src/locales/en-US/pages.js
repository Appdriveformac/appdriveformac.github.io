export default {
  'pages.layouts.userLayout.title': 'QR Menu là sản phẩm miễn phí cho phép người sử dụng sản phẩm đặt qua mã QR nhanh chóng ',
  'pages.login.accountLogin.tab': 'Đăng nhập tài khoản',
  'pages.login.accountLogin.errorMessage': 'Sai thông tin username/password(admin/ant.design)',
  ...
  'pages.404.subTitle': 'Xin lỗi, Đường dẫn bạn truy cập không tồn tại.',
  'pages.404.buttonText': 'Trở về trang chủ',
